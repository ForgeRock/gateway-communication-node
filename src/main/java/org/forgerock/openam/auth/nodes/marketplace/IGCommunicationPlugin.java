...
public class IGCommunicationPlugin extends AbstractNodeAmPlugin {
	...
	static String currentVersion = "0.0.24";
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(IGCommunicationPlugin.currentVersion, 
				Collections.singletonList(IGCommunication.class));
	}
	...
	public void onInstall() throws PluginException {
		logger.info(loggerPrefix + "Installing IG Communication service");
		pluginTools.installService(IGCommunicationService.class);
		super.onInstall();
	}
	...
	public void onStartup(StartupType startupType) throws PluginException {
		logger.info(loggerPrefix + "Starting IG Communication service");
		pluginTools.startService(IGCommunicationService.class);
	...
	public void upgrade(String fromVersion) throws PluginException {
		...
		try {
			pluginTools.upgradeAuthNode(IGCommunication.class);
			pluginTools.upgradeIdRepo(IGCommunicationService.class);
		} catch (Exception e) {
	...
	public String getPluginVersion() {
		return IGCommunicationPlugin.currentVersion;
	}
}
